...
//Donde estan los "..." puntos suspensivos va el nombre de la base de datos que creemos, en este caso es "food_store"
public class ConexionBD {
    // URL de conexión con parámetros obligatorios (Timezone y SSL deshabilitado para local)
    private static final String URL = "jdbc:mysql://localhost:3306/food_store?useSSL=false&serverTimezone=America/Argentina/Buenos_Aires&allowPublicKeyRetrieval=true";
